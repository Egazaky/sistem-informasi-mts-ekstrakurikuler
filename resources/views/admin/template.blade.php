    ...
    @stack('scripts')
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon ps-2">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ URL::asset('img/logo.png')}}" style="height: 50px; margin-left: -15px;" alt="homepage" class="light-logo" />
        ...
        <aside class="left-sidebar" data-sidebarbg="skin5">
            ...
            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                href="{{ (isset($menu) && $menu == 'dashboard') ? '' : URL::route('dashboard') }}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span
                    class="hide-menu">Dashboard</span></a></li>
            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                href="{{ (isset($menu) && $menu == 'siswa') ? '' : URL::route('data-siswa') }}" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span
                    class="hide-menu">Data Siswa</span></a></li>
            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                href="{{ (isset($menu) && $menu == 'guru') ? '' : URL::route('guru.index') }}" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span
                    class="hide-menu">Data Guru</span></a></li>
            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                href="{{ (isset($menu) && $menu == 'ekstra') ? '' : URL::route('data-ekstra') }}" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span
                    class="hide-menu">Data Ekstrakurikuler</span></a></li>
            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                href="{{ (isset($menu) && $menu == 'pertanyaan') ? '' : URL::route('pertanyaan') }}" aria-expanded="false"><i class="mdi mdi-note-plus"></i><span class="hide-menu">Pertanyaan</span></a></li>
            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                href="{{ (isset($menu) && $menu == 'berita') ? '' : URL::route('berita.index') }}" aria-expanded="false"><i class="mdi mdi-newspaper"></i><span class="hide-menu">Berita</span></a></li>
            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                href="{{ (isset($menu) && $menu == 'gallery') ? '' : URL::route('gallery.index') }}" aria-expanded="false"><i class="mdi mdi-image-multiple"></i><span class="hide-menu">Tentang Kami & Galeri</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-account-plus"></i><span class="hide-menu">Pendaftaran </span></a>
                <ul aria-expanded="false" class="collapse first-level">
                    <li class="sidebar-item"><a href="{{ route('admin.pendaftaran.index') }}" class="sidebar-link"><i class="mdi mdi-format-list-bulleted"></i><span class="hide-menu"> Data Pendaftar </span></a></li>
                    <li class="sidebar-item"><a href="{{ route('admin.pendaftaran.settings') }}" class="sidebar-link"><i class="mdi mdi-settings"></i><span class="hide-menu"> Pengaturan Halaman </span></a></li>
                </ul>
            </li>
            <li class="sidebar-item">
                <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                    <i class="mdi mdi-account"></i><span class="hide-menu">Profile </span>
                </a>
                <ul aria-expanded="false" class="collapse first-level">
                    {{-- <li class="sidebar-item">
                    ...
                    <li class="sidebar-item">
                        <a href="{{ route('admin.home-settings.index') }}" class="sidebar-link">
